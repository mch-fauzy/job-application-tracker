...
export function ArchivedList() {
  ...
  return (
    <div ref={scrollRef} className="h-full max-w-2xl space-y-3 overflow-y-auto pr-1">
      ...
      {items.map((app) => (
        <Card key={app.id} className="relative transition-colors hover:bg-accent/40">
          {/* Menu is a sibling of the link, not a child: an anchor cannot contain a button. */}
          ...
          >
            <CardHeader className="pb-1 pr-9">
